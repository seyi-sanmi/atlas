      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            {item ? 'Edit' : 'Add'} {type === 'research_area' ? 'Research Area' : 'Location'}
          </h3>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder={type === 'research_area' ? 'e.g. Artificial Intelligence' : 'e.g. London'}
            />
          </div>
...
export default function AdminHeroPage() {
  ...
  const [editType, setEditType] = useState<'research_area' | 'location'>('research_area')
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Hero Content Management</h1>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Research Areas</h2>
                <span className="text-sm text-gray-500 dark:text-gray-400">
                  ({researchAreas.filter(item => item.is_active).length} active)
                </span>
              </div>
              <button
