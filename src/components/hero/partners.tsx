...
function useTypewriterCity(cities: { name: string; image?: string }[]) {
  ...
  const [image, setImage] = useState(cities[0]?.image || "https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?q=80&w=1200&auto=format&fit=crop&ixlib=rb-4.0.1");
  ...
  // Preload next image
  useEffect(() => {
    const newImage = cities[cityIdx]?.image || "https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?q=80&w=1200&auto=format&fit=crop&ixlib=rb-4.0.1";
