...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "font-display font-medium text-lg sm:text-2xl text-secondary-text tracking-tight leading-tight line-clamp-2 group-hover:text-[#AE3813] transition-colors duration-200 cursor-pointer",
        className
      )}
      {...props}
    />
